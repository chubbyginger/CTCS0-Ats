...
namespace CTCS0_Ats
{
    public partial class AtsMain
    {
        ...
        /// <summary>
        /// Unmanaged array operations for Panel / Sound. (Modified for safety)
        /// </summary>
                ...
                get
                {
                    if (index >= Length || index < 0)
                    {
                        throw new IndexOutOfRangeException(
                            "Unmanaged array index is out of range: " +
                            AppDomain.CurrentDomain.BaseDirectory);
                    }
                    return Marshal.ReadInt32(Address, index * sizeof(int));
                }
                set
                {
                    if (index >= Length || index < 0)
                    ...
                    Marshal.WriteInt32(Address, index * sizeof(int), value);
                }
            }
        ...
        {
            userPowerPosition = handlePosition;
        }
        ...
        {
            userBrakePosition = handlePosition;
        }
        ...
        {
            userReverserPosition = handlePosition;
        }
